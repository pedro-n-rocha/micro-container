...
public class ConfigurationModule extends AbstractModule {
	...
	static ConfigurationSource source = new ConsulConfigurationSourceBuilder().withHost(System.getenv("CONSUL_HOST"))
	...
	protected void configure() {
		...
		configProvider = new ConfigurationProviderBuilder().withConfigurationSource(source)
